  ...
  useEffect(() => {
    ...
    const enterHandler = e => {
      ...
      if (cursorColorOnTarget) {
        ...
        dotRef.current && gsap.to(dotRef.current, { backgroundColor: cursorColorOnTarget, duration: 0.15, ease: 'power2.out' });
      }
      ...
      const leaveHandler = () => {
        ...
        if (cursorColorOnTarget && cornersRef.current) {
          ...
          dotRef.current && gsap.to(dotRef.current, { backgroundColor: cursorColor, duration: 0.15, ease: 'power2.out' });
        }
        ...
        if (cornersRef.current) {
          ...
          c.forEach((corner, i) => tl.to(corner, { x: positions[i].x, y: positions[i].y, duration: 0.3, ease: 'power3.out' }, 0));
        }
